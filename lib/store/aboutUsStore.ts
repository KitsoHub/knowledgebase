...
const initialPastContributors: PastContributor[] = [
  ...
  },
  {
    ...
    contributions:
      'Established TK Label implementation guidelines and cultural sensitivity training',
  },
  {
    ...
    contributions:
      'Built foundational database architecture and security protocols',
  },
]
...
const initialAboutContent: AboutContent = {
  ikms: {
    mission:
      'The Indigenous Knowledge Management System is dedicated to preserving, protecting, and sharing traditional knowledge in a manner that respects Indigenous cultural protocols and supports community sovereignty over cultural heritage.',
    vision:
      'We envision a digital future where Indigenous communities have full control over their traditional knowledge, where cultural protocols are embedded in technology, and where knowledge sharing strengthens both individual communities and intercultural understanding.',
    overview:
      'Built on the principles of community governance and cultural respect, our portal provides Indigenous communities with tools to manage their traditional knowledge according to their own cultural protocols. We implement Traditional Knowledge (TK) Labels, support multiple governance models, and ensure that access to sensitive cultural information is controlled by the communities themselves.',
    lastUpdated: new Date('2025-10-04'),
  },
  governance: {
    structure:
      'The portal operates under a distributed governance model where each community maintains sovereignty over their own knowledge while participating in a broader network of Indigenous knowledge sharing.',
    principles: [
    ...
    decisionMaking:
      'Major platform decisions are made through consensus among community leaders, with Elder councils providing cultural guidance. Each community maintains independent decision-making authority for their own collections and protocols.',
    accountability:
      'The portal is accountable to participating communities through regular reporting, community feedback sessions, and annual governance reviews. Community leaders can audit all access to their knowledge and modify protocols at any time.',
  },
  joinTeam: {
    openPositions: [
      {
        ...
        description:
          'Work directly with Indigenous communities to onboard them to the portal, provide training, and ensure cultural protocols are properly implemented.',
        requirements: [
      ...
      },
      {
        ...
        description:
          'Manage digital preservation of traditional knowledge, including audio, video, and document formats. Ensure metadata standards align with cultural requirements.',
        requirements: [
    ...
    volunteerOpportunities:
      'We welcome volunteers who are passionate about Indigenous cultural preservation. Opportunities include metadata entry, cultural translation assistance, community event support, and educational outreach. Cultural sensitivity and respect for protocols is essential.',
    internshipInfo:
      'We offer paid internships for Indigenous students interested in digital heritage, software development, library science, and community governance. Internships run for 12 weeks during summer and include mentorship from experienced team members.',
  },
}
      ...
      removeTeamMember: id =>
        set(state => ({
          teamMembers: state.teamMembers.filter(
            member => member.ikmsTeamIdentifier != id
          ),
        })),
