          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
            <div>
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Our repository trends and real time contribution tracking.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
            ...
            <Card className="shadow-sm md:col-span-2 bg-white">
              <CardHeader>
                ...
                <CardDescription>
                  Users with the most submissions this {timeRange}
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="shadow-sm bg-white">
              <CardHeader>
                ...
                <CardDescription>
                  Most frequently used tags in submissions
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  {categoriesExtras.map((tag, index) => (
                    ...
                    >
                      <span>{tag.name}</span>
                      <span className="ml-1.5 bg-primary/20 text-primary rounded-full py-0.5 px-1.5 text-[10px]">
                        {tag.count}
                      </span>
                    </div>
                  ))}
