...
export default function Home() {
  ...
  const handleTranslate = () => {
    ...
    const languageDict =
      translations[selectedLanguage.toLowerCase() as keyof Translations]
    const translation =
        ...
        <section>
          <div className="mb-1 text-center bg-gradient-to-r from-blue-50 to-indigo-100 dark:from-blue-590/50 dark:hover:to-indigo-950/50 py-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              This is a <strong>prototype</strong> for an NLP chatbot that
              translates English greetings into 20 Botswana languages, based on
              data from a{' '}
              <a
              ...
              . It supports translations for &quot;Hello,&quot; &quot;Good
              morning,&quot; and &quot;How are you?&quot; in languages like
              Setswana, Ikalanga, Nama, and more. This rule-based demo matches
              exact phrases and is a starting point for a more advanced NLP
              system (e.g., with fuzzy matching or ML models).
            </p>
          </div>
        </section>
      </div>
      <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl w-full">
          <h1 className="text-3xl font-bold text-center mb-4">
            Botswana Languages Greeting Chatbot
          </h1>
          <p className="text-gray-700 mb-6">
            ...
            morning,&quot; and &quot;How are you?&quot; in languages like
            Setswana, Ikalanga, Nama, and more. This rule-based demo matches
            exact phrases and is a starting point for a more advanced NLP system
            (e.g., with fuzzy matching or ML models).
          </p>
          <div className="mb-4">
            <label
              htmlFor="language"
