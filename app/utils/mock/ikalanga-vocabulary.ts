...
function generateNumberItems(
  ...
  for (let i = 0; i < count; i++) {
    const baseNumber =
      i < basicNumbers.length
        ? basicNumbers[i]
        : basicNumbers[i % basicNumbers.length]
    ...
    lessons: [
      {
        ...
        title: 'Numbers & Time',
        description: 'Learn how to say words in ikalanga',
        vocabulary: generateNumberItems(
          'beginner-unit-2',
          'bu2-numbers',
          10,
          'beginner',
