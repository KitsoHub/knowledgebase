      ...
      items: [
        {
          ...
          title:
            'Under the Same Sun! Parallel Issues and Mutual Challenges for San and Sami People in Research',
          metadata: {
            container: {
              title:
                'Vaartoe / Centre for Sami Research (CeSam), Umeå University',
              pages: '200',
            },
          },
          identifiers: {
          ...
          indigenousContext: {
            communitiesInvolved: ['San Council of Botswana', 'Sami Parliament'],
            tkLabels: ['culturally_sensitive', 'collaborative_research'],
        ...
        },
        {
          ...
          status: 'published',
          title:
            'Chiefs, Hunters, and San in the Creation of the Moremi Game Reserve, Okavango Delta: Multiracial Interactions and Initiatives, 1956-1979',
          metadata: {
            container: {
          ...
          notes:
            'Vol. 83. Single-authored monograph examining Indigenous ecological knowledge in conservation policy. Received positive reviews in Journal of Anthropological Research (2014) and Botswana Notes & Records',
          isFeatured: true,
          academicContext: {
            abstract:
          ...
          indigenousContext: {
            ...
            tkLabels: ['ecological_calendar', 'land_management', 'restricted'],
            communityApproval: true,
          },
          assets: [
            {
        ...
        },
        {
          ...
          metadata: {
            container: {
              title:
                'African Study Monographs, Centre for African Area Studies, Kyoto University',
            },
          },
          identifiers: {
            issn: '0285-1601',
          ...
          isFeatured: true,
          notes:
            'Vol. 35 (1). Examines transnational Indigenous identity preservation and cultural heritage systems',
          status: 'published',
          academicContext: {
            abstract:
          ...
          indigenousContext: {
            ...
            tkLabels: ['cultural_heritage', 'identity_knowledge', 'restricted'],
            communityApproval: true,
          },
          assets: [
            {
              ...
              description: 'Kyoto University Institutional Repository',
              isPrimary: true,
              requiresApproval: true,
            },
          ],
      ...
      items: [
        {
          ...
          academicContext: {
            ...
            citations: 8,
            featuredIn: ['Featured in Evolutionary Human Sciences (2025)'],
          },
          access: {
            license: 'CC-BY',
            openAccess: true,
          ...
          assets: [
            {
              ...
              description: 'Cambridge University Press publication',
              isPrimary: true,
            },
            {
              type: 'pdf',
        ...
        },
        {
          ...
          notes:
            'Forthcoming article examining Indigenous ecological knowledge systems in colonial hunting practices',
          indigenousContext: {
