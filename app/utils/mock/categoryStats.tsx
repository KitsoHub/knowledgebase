export const categories = [
  {
    name: 'Articles',
    description: 'Academic papers, research findings, and in-depth analyses',
    count: 2547,
    icon: '📄',
  },
  {
    name: 'Artifacts',
    description:
      'Historical objects, archaeological discoveries, and cultural items',
    count: 1823,
    icon: '🏺',
  },
  {
    name: 'Plants',
    description:
      'Botanical species, horticultural research, and plant ecosystems',
    count: 3012,
    icon: '🌿',
  },
  {
    name: 'Animals',
    description:
      'Wildlife species, zoological research, and animal behavior studies',
    count: 2735,
    icon: '🦊',
  },
  {
    ...
    description:
      'Traditional practices, cultural wisdom, and community heritage',
    count: 1426,
    icon: '🧠',
  },
]
