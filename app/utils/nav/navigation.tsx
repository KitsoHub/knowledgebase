...
import { BookOpen, GraduationCap, Menu, PenTool, ScrollText, Settings, UploadCloud, Users, Utensils } from "lucide-react"
...
const NavLink = memo((
    ...
    <a href={href} className={`transition-colors duration-200 ${className}`}>{children}</a>
))
    ...
    ({
        ...
        <NavigationMenuLink asChild>
            ...
            >
                ...
                <p className="line-clamp-2 text-sm leading-snug text-slate-600">{description}</p>
            </NavLink>
        </NavigationMenuLink>
    ),
)
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between transition-all duration-300 ease-in-out p-6 bg-transparent">
                                        ...
                                        <div className="row-span-3">
                                            <NavigationMenuLink asChild>
                                                <NavLink
                                                    ...
                                                    href="#featured"
                                                >
                                                    <div className="mb-2 mt-4 text-lg font-medium text-white">Featured Events</div>
                                            ...
                                            <div className="grid gap-4 grid-cols-3">
                                                <NavigationMenuLink asChild>
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            <div className="font-semibold text-slate-900 mb-1">Books</div>
                                                            <p className="text-sm text-slate-600">
                                                                Indigenous knowledge books, collections, and traditional wisdom.
                                                            </p>
                                                        </div>
                                                    </a>
                                                </NavigationMenuLink>
                                                ...
                                                <NavigationMenuLink asChild>
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            <div className="font-semibold text-slate-900 mb-1">Articles</div>
                                                            <p className="text-sm text-slate-600">
                                                                Research articles, case studies, and indigenous practices.
                                                            </p>
                                                        </div>
                                                    </a>
                                                </NavigationMenuLink>
                                                ...
                                                <NavigationMenuLink asChild>
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            <div className="font-semibold text-slate-900 mb-1">Journals</div>
                                                            <p className="text-sm text-slate-600">
                                                                Academic and peer-reviewed journals on indigenous knowledge.
                                                            </p>
                                                        </div>
                                                    </a>
                                                </NavigationMenuLink>
                                                    ...
                                                    <NavigationMenuLink asChild>
                                                        ...
                                                        >
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-slate-600">
                                                                    Guidelines on referencing indigenous sources and oral traditions.
                                                                </p>
                                                            </div>
                                                        </a>
                                                    </NavigationMenuLink>
                                                    ...
                                                    <NavigationMenuLink asChild>
                                                        ...
                                                        >
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-slate-600">
                                                                    Standards for classifying documents by type, region, and source.
                                                                </p>
                                                            </div>
                                                        </a>
                                                    </NavigationMenuLink>
                                                    ...
                                                    <NavigationMenuLink asChild>
                                                        ...
                                                        >
                                                            ...
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-slate-600">
                                                                    How to contribute books, articles, or journals to the IKMS.
                                                                </p>
                                                            </div>
                                                        </a>
                                                    </NavigationMenuLink>
                                        ...
                                        <div className="row-span-3">
                                            <NavigationMenuLink asChild>
                                                <NavLink
                                                    ...
                                                    href="#featured"
                                                >
                                                    <div className="mb-2 mt-4 text-lg font-medium text-white">Our Local Languages</div>
                                                    <p className="text-sm leading-tight text-sky-50">
            ...
            <div className="hidden md:flex items-center space-x-4">
                ...
                <Button
                    className="bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="icon" className="md:hidden hover:bg-sky-50">
                        <Menu className="h-6 w-6 text-slate-700" />
                    </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end" className="w-56 bg-white/95 backdrop-blur-sm border-sky-200">
                    ...
                    <DropdownMenuItem className="hover:bg-sky-50">
                        <NavLink href="/publications" className="w-full pl-4 text-slate-600">
                            Publications
                        </NavLink>
                    </DropdownMenuItem>
                    <DropdownMenuItem className="hover:bg-sky-50">
