...
export default function LanguageDashboard() {
  ...
  const beginnerUnits = khoekhoegowabUnits.filter(
    unit => unit.level === 'beginner'
  )
  const intermediateUnits = khoekhoegowabUnits.filter(
    unit => unit.level === 'intermediate'
  )
  const advancedUnits = khoekhoegowabUnits.filter(
    unit => unit.level === 'advanced'
  )
