...
export default function CollectionView() {
  ...
  const [viewMode, setViewMode] = useState<'grid' | 'list' | 'content-types'>(
    'content-types'
  )
  ...
  const filteredItems = currentCollection?.knowledgeItems?.filter(item => {
    const matchesSearch =
      ...
      item.content?.metadata?.topics.some(subject =>
    ...
    const matchesAccessLevel =
      ...
      item.rightsMetadata?.accessLevel === selectedAccessLevel
    ...
    <div className="p-6 space-y-6">
      ...
      <Alert className="border-secondary">
        ...
        <AlertDescription>
          ...
          This collection operates under the authority of{' '}
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="ELDER_APPROVAL_REQUIRED">
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Badge
                      className={`${accessLevelColors[item.rightsMetadata?.accessLevel?.toString() as CulturalProtocol]}`}
                    >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          <div className="flex items-center space-x-2">
                            ...
                            <Badge
                              className={`text-xs ${accessLevelColors[item.rightsMetadata?.accessLevel as CulturalProtocol]}`}
                            >
                              {item.rightsMetadata?.accessLevel.replace(
                                /_/g,
                                ' '
                              )}
                            </Badge>
