...
export default function APIADashboard() {
  ...
  const simulateAnalysis = async () => {
    ...
    const mockAnalysis: PatentAnalysis = {
      ...
      problemSolved:
        'Indigenous communities face challenges in protecting traditional knowledge from unauthorized patents and commercialization. Existing patent systems are not designed to recognize or protect traditional knowledge, leading to biopiracy and cultural appropriation.',
      technicalFeatures: [
      ...
      priorArtMatches: [
        {
          id: 'US10234567B2',
          title:
            'System and method for cultural heritage preservation using digital archives',
          similarity: 0.68,
          noveltyRisk: 'medium',
          abstract:
            'A system for preserving cultural heritage through digital archiving and metadata management. The system includes document scanning, cataloging, and access control features for museum and library applications.',
          date: '2019-03-15',
        },
        {
          id: 'US9876543B1',
          ...
          noveltyRisk: 'medium',
          abstract:
            'An artificial intelligence system for searching patent databases to identify prior art. Uses natural language processing and semantic similarity to match patent claims with existing patents.',
          date: '2018-07-22',
        },
        {
          id: 'WO2020123456A1',
          ...
          noveltyRisk: 'high',
          abstract:
            'A database system for storing traditional knowledge with community-defined access protocols. Includes features for cultural sensitivity labeling and stakeholder permission management.',
          date: '2020-06-11',
        },
        {
          id: 'US10987654B2',
          ...
          noveltyRisk: 'low',
          abstract:
            'A vector database architecture optimized for high-dimensional embedding storage and cosine similarity searches for document retrieval applications.',
          date: '2021-01-08',
        },
      ],
      recommendations: [
        ...
        <div className="space-y-6">
          <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-blue-900 via-blue-800 to-blue-600 p-8 text-white">
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h1 className="text-3xl">
                    CIPA AI Patent Intelligence Engine
                  </h1>
              ...
              <p className="text-blue-50 max-w-3xl mt-4">
                Leveraging AI-powered semantic analysis to identify, documents,
                and protect indigenous innovations. Our system combines cultural
          ...
          <Alert className="border-blue-200 bg-blue-50">
            ...
            <AlertDescription className="text-blue-900">
              <strong>Important:</strong> This tool helps communities identify
              potential patent conflicts and document innovations. It does not
              constitute legal advice. Consult with IP attorneys familiar with
              indigenous knowledge rights before filing patents.
            </AlertDescription>
          </Alert>
          ...
          <section id="data-input">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Describe your innovation, upload documents, or paste prior
          ...
          <section id="analysis-result">
            {analysis &&
              PatentAnalysisResults({ inventionText, analysis, uploadedFiles })}
          </section>
        </div>
      </main>
    </div>
