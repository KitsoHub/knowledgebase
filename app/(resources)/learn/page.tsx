...
export default function LanguageLearnDashboard() {
  const [contributorView, setContributorView] = useState<'cards' | 'table'>(
    'table'
  )
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-xl">
                Contributor Recognition (KitsoHub Section II.A.3)
              </h2>
              <p className="text-muted-foreground">
                Contributors are recognized for their specific roles and
                contributions, not as authors. This follows ORCID and KITSOHUB
