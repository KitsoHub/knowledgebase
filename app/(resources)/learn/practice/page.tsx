            ...
            <Tabs defaultValue="exercises" className="mb-8">
                ...
                <TabsContent value="exercises" className="space-y-4">
                    ...
                    {!activeExercise ? (<>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>Vocabulary Matching</CardTitle>
                                <CardDescription>Match the words with their definitions</CardDescription>
                            </CardHeader>
                            <CardContent>
                                <MatchingExercise
                                    pairs={[
                                        { id: "1", term: "Dumela", definition: "A greeting" },
                                        { id: "2", term: "Go siame", definition: "A farewell" },
                                        { id: "3", term: "Kea leboga", definition: "Expression of gratitude" },
                                        { id: "4", term: "Tlaya kwano", definition: "A command" },
                                    ]}
                                    onComplete={() => setActiveExercise(null)}
                                />
                            </CardContent>
