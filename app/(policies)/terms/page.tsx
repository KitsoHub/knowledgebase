  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="max-w-7xl mx-auto space-y-0">
            ...
            >
              <div className=" relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center ">
                <div className="text-white/80 space-y-4">
                  ...
                  <p className="text-white/80 leading-relaxed">
                    1) Respect Traditional Knowledge Labels™ (e.g., "Women-Only
                    Knowledge," "Elder-Approved") <br />
                    2) Comply with Botswana's National Innovation Policy (2019)
                    and Nagoya Protocol <br />
                    3) Acknowledge that CC BY licensing does NOT apply to
        ...
        <section className="mb-24 max-w-full">
          <div className="mb-12">
            <h4 className="text-2xl md:text-3xl mb-4">2. Permitted Use</h4>
          </div>
            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr className="bg-white dark:bg-gray-800">
                  ...
                  <td className="px-6 py-4">Researchers</td>
                ...
                <tr className="bg-white dark:bg-gray-800">
                  ...
                  <td className="px-6 py-4">View CC BY-tagged content </td>
                </tr>
                <tr className="bg-white dark:bg-gray-800">
                  <th
                    scope="row"
            ...
            >
              <div className=" relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center ">
                <div className="text-white/80 space-y-4">
                  ...
                  <p className="text-white/80 leading-relaxed">
                    1) Never attempt to bypass cultural access controls (e.g.,
                    falsifying elder approval). <br />
                    2) Never commercialize knowledge without benefit-sharing
                    agreement (royalties ≥15%). <br />
                    3) Never extract geotags for sacred sites (violators face
                    kgotla tribunal referral).
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        <section className="mb-24 max-w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-24">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Automatic royalty claims via Botswana's Intellectual Property
                Office
              </p>
            </motion.div>
          </div>
        ...
        <section className="mb-24 max-w-full">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            Kitso-Hub is provided "as is" under community stewardship. The Open
            Source Botswana Community:
          </p>
          <br />

          <p className="text-white/80 leading-relaxed">
            1) Is not liable for misuse of knowledge by third parties. <br />
            2) Reserves the right to remove content violating cultural
            protocols. <br />
            3) Acknowledges University of Botswana and UNDP-UNIPOD as funders
            (not owners).
          </p>
        </section>
      </div>
