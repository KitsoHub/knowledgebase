      ...
      <main className="flex-1 space-y-4 p-4 md:p-8">
        ...
        <Tabs defaultValue="overview" className="w-full rounded-sm space-y-4">
          ...
          <TabsContent value="overview" className="space-y-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
              ...
              <Card className="lg:col-span-4">
                <CardHeader>
                  <CardTitle>Entry Growth Over Time</CardTitle>
                  <CardDescription>
                    Tracking the growth of the knowledge base
                  </CardDescription>
                </CardHeader>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <Card className="lg:col-span-2">
                <CardHeader>
                  ...
                  <CardDescription>
                    Connections between different data types and sources
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="space-y-4">
                    <div className="rounded-lg border p-3">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-medium">Historical Correlation</h3>
                      </div>
                      <p className="mt-2 text-sm">
                        Strong correlation detected between artifact discoveries
                        and indigenous knowledge records in the Kasane region.
                      </p>
                    ...
                    <div className="rounded-lg border p-3">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-medium">Botanical Pattern</h3>
                      </div>
                      <p className="mt-2 text-sm">
                        Emerging pattern identified in medicinal plant usage
                        across 3 different indigenous cultures.
                      </p>
                      <div className="mt-2 flex items-center text-sm">
                        <Button variant="link" className="h-auto p-0 text-sm">
                          View details
                    ...
                    <div className="rounded-lg border p-3">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-medium">Temporal Trend</h3>
                      </div>
                      <p className="mt-2 text-sm">
                        Significant increase in cross-disciplinary research
          ...
          <TabsContent value="sources" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Geographical Distribution of Data Sources</CardTitle>
                <CardDescription>
                  Visual representation of where data originates from
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="grid gap-4 md:grid-cols-2 ">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="h-[300px] rounded-md border bg-muted/50 p-4 flex items-center justify-center">
                    <p className="text-muted-foreground">
                      Source type distribution chart would appear here
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Source Credibility Ratings</CardTitle>
                  <CardDescription>
                ...
                <CardContent>
                  <div className="h-[300px] rounded-md border bg-muted/50 p-4 flex items-center justify-center">
                    <p className="text-muted-foreground">
                      Credibility rating visualization would appear here
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <TabsContent value="timeline">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Chronological view of data entries and historical events
                </CardDescription>
              </CardHeader>
              <CardContent>
