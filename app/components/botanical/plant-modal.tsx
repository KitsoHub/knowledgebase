                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {plant.medicinalQualities.map(quality => (
                          <Badge key={quality} variant="default">
                            {quality}
                          </Badge>
                        ))}
                      </div>
                    ...
                    <CardContent className="pt-6 space-y-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {plant.modernMedicine.activeCompounds.map(
                            compound => (
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {plant.modernMedicine.clinicalStudies.map(
                            (study, index) => (
                              <li
                                key={index}
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                          {plant.modernMedicine.approvedUses.map(
                            (use, index) => (
                              <li key={index}>{use}</li>
                            )
                          )}
                  ...
                  <Card>
                    <CardContent className="pt-6 space-y-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {plant.homeopathicUses.preparations.map(prep => (
                            <Badge key={prep} variant="outline">
                              {prep}
                            </Badge>
                          ))}
                        </div>
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                          {plant.homeopathicUses.conditions.map(
                            (condition, index) => (
                  ...
                  <Card>
                    <CardContent className="pt-6 space-y-4">
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                          {plant.research.futureDirections.map(
                            (direction, index) => (
