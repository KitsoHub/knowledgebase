    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">
          Non-author contributor recognition per ORCID and KitsoHub guidelines.
          Contributors are acknowledged for specific roles, not authorship.
        </p>
      </CardHeader>
                    ...
                    <TableCell>
                      <div className="space-y-1">
                        ...
                        <div className="text-xs">
                          ...
                          >
                            {contributor.languageIds
                              ? contributor.languageIds.join(', ')
                              : 'N/A'}
                          </Badge>
                        </div>
                      </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            ...
            <div className="text-center">
              <div className="text-lg text-purple-600">
                {
                  Array.from(new Set(filteredContributors.map(c => c.country)))
                    .length
                }
              </div>
        ...
        <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <div className="text-xs text-green-700">
              ...
              <p>
                All contributors are properly acknowledged for their specific
                roles and contributions to this translation repository. No
                individual qualifies for authorship as per ORCID and KitsoHub
