...
export default function PublicationsBrowse() {
  ...
  const handleSearch = (query: string) => {
    ...
    const filtered = publicationsData.categories
      ...
      .filter(publication => {
        ...
        const matchesCategory =
          selectedCategory === 'all' || publication.type === selectedCategory
  ...
  const handleCategorySelect = (category: string) => {
    ...
    const filtered =
      category === 'all'
        ? publicationsData.categories.flatMap(category => category.items)
        : publicationsData.categories.find(cat => cat.name === category)
            ?.items || []
    setFilteredPublications(filtered)
  }
    ...
    <div className="min-h-screen bg-background mt-28">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
              Discover a curated collection of knowledge publications. Stay
              informed with the latest insights and updates in the field of
      ...
      <div className="mt-12 p-6 bg-muted rounded-lg">
        ...
        <p className="text-muted-foreground mb-4">
          Traditional Knowledge Labels help identify cultural sensitivity and
          usage rights. These labels are part of the Local Contexts initiative
