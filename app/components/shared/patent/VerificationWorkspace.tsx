...
import { mockApplications, PatentApplication } from '@/app/utils/mock/patent-data';
...
export default function VerificationWorkspace() {
  ...
  const [searchResults] = useState<SearchResult[]>([
    { title: 'Similar method for data processing', relevance: "High", source: 'USPTO', publicationDate: '2025-04-15' },
    { title: 'Related system architecture', relevance: "Medium", source: 'WIPO', publicationDate: '2025-05-23' },
    { title: 'Potentially overlapping claims', relevance: "Medium", source: 'EPO', publicationDate: '2025-02-10' },
  ]);
     ...
     {/* Right side: Search and verification tools */}
                <div className="flex flex-col">
                  <Tabs defaultValue="search">
                    ...
                    <TabsContent value="search" className="p-0 m-0 border rounded-lg mt-4">
                      <SearchResults results={searchResults} />
                    </TabsContent>

                    <TabsContent value="validate" className="m-0 border rounded-lg mt-4">
                      <VerificationTools />
                    </TabsContent>
                  </Tabs>
                </div>
