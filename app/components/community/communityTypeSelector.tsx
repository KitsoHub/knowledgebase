  ...
  const governanceTypes = [
    {
      ...
      title: 'Elder Council',
      description:
        'Traditional governance led by community elders with special cultural authority',
      icon: Crown,
      emphasis: true,
    },
    {
      ...
      description:
        'Democratically elected council representing community interests',
      icon: Users,
      emphasis: false,
    },
    {
      ...
      description:
        'Collaborative leadership focused on environmental and cultural stewardship',
      icon: TreePine,
      emphasis: false,
    },
  ]
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Choose the governance structure that best represents your community's
          leadership
        </p>
      </div>
