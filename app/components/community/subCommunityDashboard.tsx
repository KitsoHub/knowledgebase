...
export default function SubCommunityDashboard({
  onNavigate,
  onBack,
}: SubCommunityDashboardProps) {
  ...
  const getProtocolColor = (protocol: string) => {
    switch (protocol) {
      case 'PUBLIC':
        return 'protocol-public'
      case 'COMMUNITY_ONLY':
        return 'protocol-community'
      default:
        return 'protocol-restricted'
    }
  }
      ...
      <div className="flex items-center space-x-2">
        ...
        >
          ...
          <DialogContent className="max-w-6xl max-h-[90vh] overflow-auto">
            <DialogHeader>
              <DialogTitle>
                Contribute to {currentSubCommunity?.title}
              </DialogTitle>
              <DialogDescription>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <DialogContent className="max-w-6xl max-h-[90vh] overflow-auto">
                <DialogHeader>
                  <DialogTitle>
                    Create Collection in {currentSubCommunity?.title}
                  </DialogTitle>
                  <DialogDescription>
                    Create a new thematic collection for this sub-community
                  </DialogDescription>
                </DialogHeader>
                <CollectionCreationFlow
                  parentCommunity={
                    currentSubCommunity ? currentSubCommunity : null
                  }
                  onComplete={() => setShowCollectionDialog(false)}
                ...
                <Card className="col-span-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Start organizing knowledge by creating your first
                      collection.
                    </p>
                    <Button onClick={() => setShowCollectionDialog(true)}>
                      <Plus className="w-4 h-4 mr-2" />
