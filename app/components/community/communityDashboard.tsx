...
export default function communityDashboard({
  ...
  const { currentCommunity, setCurrentCommunity, setCurrentSubCommunity } =
    useCommunityStore()
  const [showDeleteDialog, setShowDeleteDialog] = useState(false)
  const [showEditCommunity, setShowEditCommunity] = useState(false)
  const [showSubCommunityCreation, setShowSubCommunityCreation] =
    useState(false)
  ...
  const handleExportMetadata = () => {
    console.log(
      'Export metadata for community:',
      currentCommunity.communityIdentifier
    )
  }
  ...
  return (
    <div className="space-y-6">
                ...
                <Card className="col-span-full">
                  <CardContent className="p-8 text-center">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Start organizing knowledge by creating your first sub
                      community.
                    </p>
      ...
      <Dialog
        open={showSubCommunityCreation}
        onOpenChange={setShowSubCommunityCreation}
      >
