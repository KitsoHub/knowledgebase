...
export default function KnowledgeItemViewer({
  item,
  onBack,
  onExport,
            ...
            <div className="space-y-4">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Duration: {item.content?.duration} • Size:{' '}
              ...
              {item.content?.metadata && (
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {item.culturalMetadata?.culturalContext?.language}
                    </span>
                  </div>
                  {item.content.metadata.instruments && (
                    <div className="flex justify-between">
                      ...
                      <span>
                        {item.content.metadata.instruments.join(', ')}
                      </span>
                    </div>
                  )}
                </div>
              ...
              {item.content?.metadata && (
                <div className="space-y-2 text-sm border-t pt-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>
                      {item.content.metadata.wordCount?.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="p-4 space-y-2 text-sm">
                ...
                {item.content.metadata.techniques && (
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-wrap gap-1">
                      {item.content.metadata.techniques.map(
                        (technique: string) => (
                          <Badge
                            key={technique}
                            variant="outline"
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                {
                  accessLevelDescriptions[
                    item.rightsMetadata?.accessLevel.toString() as CulturalProtocol
                  ]
                }
              </p>
            </CardContent>
        ...
        <TabsContent value="context" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Understanding the cultural significance and proper protocols for
                this knowledge
              </CardDescription>
            </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span>
                        {item.culturalMetadata?.culturalContext?.region}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">Language:</span>
                    ...
                    {item.content?.metadata?.season && (
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Season:</span>
                        <span>
                          {item.culturalMetadata?.culturalContext?.season}
                        </span>
                      </div>
                    )}
