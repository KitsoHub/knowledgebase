      ...
      <Sidebar collapsible="icon">
        <SidebarHeader className="flex items-center justify-between p-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold group-data-[collapsible=icon]:hidden">IKMS</span>
          </div>
              ...
              <SidebarMenu>
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={pathname === "/compliance"} tooltip="Compliance">
                    <Link href="/compliance"><Briefcase /><span>Workflow</span></Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={pathname === "/insights"} tooltip="Insights">
                    <Link href="/insights"><BarChart /><span>Items</span></Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={pathname === "/insights"} tooltip="Insights">
                    <Link href="/insights"><BarChart /><span>Supervisors</span></Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={pathname === "/insights"} tooltip="Insights">
                    <Link href="/insights"><BarChart /><span>Curation Tasks</span></Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={pathname === "/insights"} tooltip="Insights">
                    <Link href="/insights"><BarChart /><span>Withdrawn Items</span></Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={pathname === "/insights"} tooltip="Insights">
                    <Link href="/insights"><BarChart /><span>Private Items</span></Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={pathname === "/insights"} tooltip="Insights">
                    <Link href="/insights"><BarChart /><span>Import Metadata</span></Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
                                <SidebarMenuItem>
                  <SidebarMenuButton asChild isActive={pathname === "/insights"} tooltip="Insights">
                    <Link href="/insights"><BarChart /><span>Batch Import</span></Link>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              </SidebarMenu>
            </SidebarGroupContent>
