...
export default function SubCommunityCreationFlow({
  onComplete,
  onCancel,
  parentCommunity,
}: SubCommunityCreationFlowProps) {
  // get current community
  const [step, setStep] = useState<CommunityGovernanceSteps>(
    CommunityGovernanceSteps.BASIC
  )
  const [subCommunityData, setSubCommunityData] = useState<
    Partial<SubCommunityData>
  >({
    title: '',
    description: '',
          ...
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground">
                Define the core detailts of your sub-community
              </p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <Input
                  ...
                  onChange={e => {
                    ...
                    updateData({
                      title,
                      communityIdentifier:
                        generateCommunityIdentifier().toString(),
                    })
                  }}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    updateData({ geographicRegion: e.target.value })
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    updateData({ communityIdentifier: e.target.value })
                  }
          ...
          <div className="space-y-6">
            <div className="text-center mb-6">
              <h3 className="text-xl mb-2">
                Indigenous Authority & Custodians
              </h3>
              <p className="text-muted-foreground">
                Assign cultural leadership and custodial responsibilities
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <Select
                  ...
                  onValueChange={value =>
                    updateData({ indigenousAuthorityId: value })
                  }
                >
                  <SelectTrigger>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  The person responsible for cultural protocols and community
                  governance
                </p>
              </div>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={value => {
                    if (
                      !subCommunityData.custodianIds?.includes(value) &&
                      value !== subCommunityData.indigenousAuthorityId
                    ) {
                      updateData({
                        custodianIds: [
                          ...(subCommunityData.custodianIds || []),
                          value,
                        ],
                      })
                    }
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {subCommunityData.custodianIds?.map(custodianId => {
                    const custodian = parentCommunity?.members?.find(
                      m => m.id === custodianId
                    )
                    return custodian ? (
                      <Badge
                      ...
                      >
                        ...
                        <button
                          onClick={() =>
                            updateData({
                              custodianIds:
                                subCommunityData.custodianIds?.filter(
                                  id => id !== custodianId
                                ),
                            })
                          }
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground">
                Set Traditional Knowledge labels and access protocols
              </p>
            </div>
                  ...
                  {tkLabelOptions.map(({ label, title, description }) => (
                    <Card
                      ...
                      className={`cursor-pointer transition-all ${
                        (subCommunityData.localContextLabels || []).includes(
                          label
                        )
                          ? 'ring-2 ring-primary'
                          : ''
                    ...
                    >
                      <CardContent className="p-4">
                        <div className="flex items-start space-x-3">
                          <Checkbox
                            checked={(
                              subCommunityData.localContextLabels || []
                            ).includes(label)}
                            onChange={() => {}}
                          />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {protocolOptions.map(({ value, title, description }) => (
                    <Card
                      key={value}
                      className={`cursor-pointer transition-all ${
                        (subCommunityData.protocols || []).includes(value)
                          ? 'ring-2 ring-primary'
                          : ''
                      }`}
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-mono">
                      {subCommunityData.communityIdentifier}
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm flex items-center space-x-1">
                    ...
                    <span>
                      {parentCommunity?.members?.find(
                        m => m.id === subCommunityData.indigenousAuthorityId
                      )?.name || user?.name}
                    </span>
                  </p>
                </div>
                ...
                {subCommunityData.custodianIds &&
                  subCommunityData.custodianIds.length > 0 && (
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-1">
                        {subCommunityData.custodianIds.map(custodianId => {
                          ...
                          return custodian ? (
                            <Badge key={custodianId} variant="secondary">
                              {custodian.name}
                            </Badge>
                          ) : null
                        })}
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Establish a cultural sub-group within{' '}
          {parentCommunity?.identity.title}
        </p>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between text-sm">
          {['Basic', 'Authority', 'Protocols', 'Review'].map(
            (stepName, index) => {
