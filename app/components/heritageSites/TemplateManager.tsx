...
const predefinedTemplates: MetadataTemplate[] = [
  {
    ...
    description:
      'Standard template for UNESCO World Heritage Site documentation',
    category: 'heritage',
    accessLevel: 'public',
    standardsCompliance: {
      unesco: true,
    ...
    fields: [
      {
        ...
        type: 'text',
        required: true,
        placeholder: 'Official heritage site name',
      },
      { name: 'Historical Period', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: true,
        description: 'Describe the cultural and historical significance',
      },
      {
      ...
      { name: 'UNESCO Criteria', type: 'textarea', required: true },
      {
        ...
        type: 'textarea',
        required: false,
        description: 'Current or potential threats to the site',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Template for documenting indigenous languages and linguistic heritage',
    category: 'language',
    ...
    fields: [
      ...
      {
        name: 'Community Permission',
        type: 'checkbox',
        required: true,
        description: 'Community has given permission for documentation',
      },
    ],
  ...
  },
  {
    ...
    description:
      'Sensitive template for documenting sacred and ceremonial sites',
    category: 'sensitive',
    accessLevel: 'closed',
    standardsCompliance: {
      unesco: false,
    ...
    fields: [
      ...
      { name: 'Associated Tribe/Community', type: 'text', required: true },
      {
        ...
        type: 'textarea',
        required: false,
        description: 'General description without sensitive details',
      },
      { name: 'Access Restrictions', type: 'textarea', required: true },
      {
        ...
        type: 'checkbox',
        required: true,
        description: 'Elders have been consulted about this documentation',
      },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: 'Knowledge Holders',
        type: 'text',
        required: false,
        description: 'General description, not specific names',
      },
      {
        name: 'Conservation Status',
        type: 'select',
        required: true,
        options: ['Pristine', 'Good', 'Degraded', 'Severely Impacted'],
      },
      {
        name: 'Community Sharing Permission',
        type: 'checkbox',
        required: true,
      },
    ],
...
export function TemplateManager() {
  const [templates, setTemplates] =
    useState<MetadataTemplate[]>(predefinedTemplates)
  const [selectedTemplate, setSelectedTemplate] =
    useState<MetadataTemplate | null>(null)
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Manage metadata templates for different types of cultural heritage
            sites
          </p>
        </div>
              ...
              >
                <CardHeader>
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    ...
                    <Badge
                      className={getAccessLevelColor(template.accessLevel)}
                    >
          ...
          <div className="grid gap-6">
              ...
              <CardContent>
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">
                    ...
                    Organization) standards for cultural heritage documentation.
                  </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">
                    United Nations Development Programme guidelines for
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">
                    UNICEF standards for protecting children in cultural
                    heritage documentation and activities.
                  </p>
                  <div className="space-y-2">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <p className="text-sm text-gray-600">
                    Protocols for respecting and protecting indigenous knowledge
                    systems and traditional cultural expressions.
                  </p>
                  <div className="space-y-2">
            ...
            <CardContent className="space-y-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {selectedTemplate.standardsCompliance.unesco && (
                    <Badge className="bg-blue-50 text-blue-700">UNESCO</Badge>
                  )}
                  {selectedTemplate.standardsCompliance.undp && (
                    <Badge className="bg-green-50 text-green-700">UNDP</Badge>
                  )}
                  {selectedTemplate.standardsCompliance.unicef && (
                    <Badge className="bg-purple-50 text-purple-700">
                      UNICEF
                    </Badge>
                  )}
                  {selectedTemplate.standardsCompliance.localContext && (
                    <Badge className="bg-orange-50 text-orange-700">
                      Local Context
                    </Badge>
                  )}
                  {selectedTemplate.standardsCompliance.indigenous && (
                    <Badge className="bg-red-50 text-red-700">Indigenous</Badge>
                  )}
                </div>
              </div>
              ...
              <div>
                <h4 className="font-medium mb-3">
                  Template Fields ({selectedTemplate.fields.length})
                </h4>
                <div className="space-y-3">
